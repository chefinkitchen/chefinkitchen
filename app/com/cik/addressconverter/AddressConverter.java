package com.cik.addressconverter;
...
public class AddressConverter {
 ...
 public static void main(String[] args) throws IOException {
  ...
  GoogleResponse res = new AddressConverter().convertToLatLong("11207 crystal ridge drive, watchung, NJ");
  ...
  System.out.println("\n");
  GoogleResponse res1 = new AddressConverter().convertFromLatLong("40.6361605,-74.4282388");
